...
if(isset($_POST['save'])){
   ...
   $sql = "INSERT INTO system_admin (admin_Email,admin_User,admin_Password)
   VALUES ('$admin_Email', '$admin_User', '$admin_Password')";  
...
<table>
    ...
    <h1>เพิ่มข้อมูลลงในตาราง</h1>
      ...
      <div class="form-inline">
       ...
       <textarea type="varchar(30)" id="admin_Email"  name="admin_Email" rows="2" cols="100" placeholder="กรอกอีเมล์ผู้ดูแลระบบ" style="resize:none" input type="varchar(30)" class="form-control "></textarea>
       <br><br>
       
       <label>ชื่อผู้ดูแลระบบ :  </label>
       <textarea type="varchar(50)"   id="admin_User"  name="admin_User" rows="2" cols="100" placeholder="กรอกชื่อผู้ดูแลระบบ " style="resize:none" input type="varchar(50)" class="form-control "></textarea>
       <br><br>

       <label>รหัสผ่าน  :  </label>
       <textarea type="varchar(8)"  class="form-control" id="admin_Password"  name="admin_Password" rows="2" cols="100" placeholder="กรอกรหัสผ่าน" style="resize:none" input type="varchar(8)" class="form-control "></textarea>
       <br><br>
       </div>
