<head>
    <title>อื่นๆนานาชาติ</title></title>
    <meta charset="utf-8">
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" bgcolor="#FFFFFF" text="#000000" alink="#003399" link="#003399" vlink="#003399" >
  ...
  <div class="row content">
    ...
    <div class="input-group" class="text-dark" bgcolor="#FF3366">
      ...
      <form method="post">
      <table border="2" >
      <h3 align="center"> <font color="blue"><B>รวมสูตรเด็ดเมนูอาหารชาติอื่น ๆ พร้อมวิธีทำง่ายๆ ใครๆ ก็ทำได้</B></h3></FONT> <br>
     
      <?php
      include "connect.php";

      
      $sql = "SELECT * FROM menu INNER JOIN attach_file ON menu.menu_name = attach_file.menu_name WHERE menu.active='1' and  international = '11' ";
