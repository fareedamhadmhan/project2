...
$name_type = $_GET["type"];
$sql_type = "SELECT * FROM material WHERE material='$name_type' ";
...
<center>
      ...
      $sql_menu_pic = "SELECT * FROM menu INNER JOIN attach_file ON menu.menu_name = attach_file.menu_name WHERE menu.active='1' and material='$id_type' ";
