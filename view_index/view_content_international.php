...
$name_type = $_GET["type"];
$sql_type = "SELECT * FROM international WHERE international='$name_type' and active='1' ";
...
<center>
      ...
      $sql_menu_pic = "SELECT * FROM menu INNER JOIN attach_file ON menu.menu_name = attach_file.menu_name WHERE menu.active='1' and international='$id_type' ";
