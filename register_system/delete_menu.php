...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" bgcolor="#FFFFFF" text="#000000" alink="#003399" link="#003399" vlink="#003399">
  ...
  <div class="container-fluid">
    ...
    <h2 align="center">ลบสูตรอาหาร</h2>
    <center>
      ...
      <button class="btn btn-light" onclick="delete_menu()">ค้นหา</button>
      <br><br>
    ...
    <script>
      ...
      function delete_menu_submit() {
        var formData = new FormData(document.forms.namedItem("data1"));
        $.ajax({
          url: "delete_menu_content_save.php",
          type: 'POST',
          data: formData,
          async: false,
          success: function(data) {
